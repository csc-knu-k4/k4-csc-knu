...
import { Flex, Text, Highlight, Input, chakra, useRecipe } from '@chakra-ui/react';
...
const Footer = () => {
  ...
  return (
    <Flex bgColor="#FCEDE6" flexDir="row" justifyContent="center" alignItems="center" mt="130px">
